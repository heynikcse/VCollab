...
export default function ProfileEditPage() {
  ...
  return (
    <div className="max-w-lg">
      <button onClick={() => navigate('/profile')} className="text-sm text-ink-faint hover:text-ink mb-4">
        ← Back to profile
      </button>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-line rounded-xl p-7 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <label className="cursor-pointer">
            <span className="text-sm font-medium text-ink underline underline-offset-2">Change photo</span>
